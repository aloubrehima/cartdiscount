...
class TestStudentLists(TestCase):
    ...
    def test_remove_student_not_in_list(self):
        test_class = ClassList(2)
        with self.assertRaises(StudentError):
            test_class.remove_student('Not in the List')
    ...
    def test_is_enrolled_student_not_present(self):
        test_class = ClassList(2)
        test_class.add_student('Alou Haidara')
        test_class.add_student('Mohamed Dieng')
        self.assertFalse(test_class.is_enrolled('Abdallah Coulibaly'))
    ...
    def test_index_of_student_not_present(self):
        ...
        test_class.add_student('Hermione')
        test_class.add_student('Ron')
        self.assertIsNone(test_class.index_of_student('Dobby'))
